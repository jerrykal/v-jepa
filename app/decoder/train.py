        ...
        for itr in range(ipe):
            ...
            def train_step():
                ...
                def forward_decode(h):
                    c = decoder(h) #[B, 3, T, H_out, W_out]
                    return c
                

                def recon_loss_fn(preds, targets, loss_type='l1', loss_exp=2.0):
                ...
                with torch.cuda.amp.autocast(dtype=dtype, enabled=mixed_precision):
                    h = forward_encoder(clips)
                    hat_clips = forward_decode(h)
                    loss_recon = recon_loss_fn(hat_clips, clips, loss_type='l1')
            ...
            (loss, loss_recon, _new_lr, _new_wd, grad_stats, grad_stats_dec, optim_stats,), gpu_etime_ms = gpu_timer(train_step)
            ...
            recon_loss_meter.update(loss_recon)
